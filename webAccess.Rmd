...
```
## Website access
```{r loadperdaybrowse, include=TRUE, eval=TRUE}
### Daily usage
...
perdayCount <- data.browse %>%
  ...
  arrange(n)
```
```{r plotperdaybrowse, fig.width=20, fig.height=6, include=TRUE, eval=TRUE}
### Per day usage, total
...
pUser
```
```{r loadtop100browse, include=TRUE, eval=TRUE}
### Data
dataaccessCount <- data.browse %>%
  ...
  arrange(desc(n))
```
```{r plot100filesbrowse, fig.width=20, fig.height=6, include=TRUE, eval=TRUE}
### Most popular files
