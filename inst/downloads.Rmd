...
output: 
  html_document: 
    keep_md: yes
params:
  projectId: !r 'syn2862345'
  nMonths: 9
  useTeamGrouping: FALSE
  aclTeamOrder: !r c("3323597", "3330234", "syn2862345", "3332397")
---
...
### Download statistics from `r min(monthBreaksDf$beginTime)` to `r max(monthBreaksDf$endTime)`.
